...
def train(C, data_gen_train):
    ...
    for epoch_num in range(C.num_epochs):
        ...
        print('Epoch {}/{}'.format(C.r_epochs + 1, C.total_epochs))
...
def display_after_training(C, record_df):
    ...
    plt.subplot(1,2,1)
    plt.plot(np.arange(0, C.r_epochs), record_df['mean_overlapping_bboxes'], 'r')
    plt.title('mean_overlapping_bboxes')
    plt.subplot(1,2,2)
    plt.plot(np.arange(0, C.r_epochs), record_df['class_acc'], 'r')
    plt.title('class_acc')
    ...
    plt.figure(figsize=(15,5))
    plt.subplot(1,2,1)
    plt.plot(np.arange(0, C.r_epochs), record_df['loss_rpn_cls'], 'r')
    plt.title('loss_rpn_cls')
    plt.subplot(1,2,2)
    plt.plot(np.arange(0, C.r_epochs), record_df['loss_rpn_regr'], 'r')
    ...
    plt.figure(figsize=(15,5))
    plt.subplot(1,2,1)
    plt.plot(np.arange(0, C.r_epochs), record_df['loss_class_cls'], 'r')
    plt.title('loss_class_cls')
    plt.subplot(1,2,2)
    plt.plot(np.arange(0, C.r_epochs), record_df['loss_class_regr'], 'r')
    plt.title('loss_class_regr')
    plt.show()

    plt.plot(np.arange(0, C.r_epochs), record_df['curr_loss'], 'r')
